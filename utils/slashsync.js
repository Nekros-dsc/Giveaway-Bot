...
module.exports = async (client, commands, options = {
    ...
    log(`[SLASH] ➕ ${newCommands.length} nouvelles commandes!`);
    ...
    log(`[SLASH] ➖ ${deletedCommands.length} commandes supprimées!`);
    ...
    log(`[SLASH] 🔁 ${updatedCommandCount} commandes mise a jour!`);
